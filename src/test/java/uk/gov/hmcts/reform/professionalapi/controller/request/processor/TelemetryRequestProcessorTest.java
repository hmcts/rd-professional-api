...
public class TelemetryRequestProcessorTest {
    ...
    public void testProcess() throws Exception {
        ...
        assertThat(requestTelemetry.getUrlString()).isEqualTo("http://test.com?email=ab****.com");
    }
    ...
    public void testProcessPathParams() throws Exception {
        ...
        telemetryRequestProcessor.process(requestTelemetry);
        assertThat(requestTelemetry.getUrlString()).isEqualTo("http://test.com/ab****.com");
    }
    ...
    public void testProcessPathParamsAndQueryParams() throws Exception {
        ...
        telemetryRequestProcessor.process(requestTelemetry);
        assertThat(requestTelemetry.getUrlString()).isEqualTo("http://test.com/ab****.com?email=ab****.com");
    }
