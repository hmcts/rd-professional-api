...
public class ProfessionalExternalUserControllerTest {
    ...
    public void testFindUsersByOrganisation() {
        ...
        ResponseEntity<?> actual = professionalExternalUserController.findUsersByOrganisation(organisation.getOrganisationIdentifier(), "true", null, "", pageableMock);
    ...
    public void testFindUsersByOrganisationWithPuiCaseManager() {
        ...
        ResponseEntity<?> actual = professionalExternalUserController.findUsersByOrganisation(organisation.getOrganisationIdentifier(), "true", null, "Pending", pageableMock);
        assertThat(actual).isNotNull();
        assertThat(actual.getStatusCode().value()).isEqualTo(expectedHttpStatus.value());
    }
}
