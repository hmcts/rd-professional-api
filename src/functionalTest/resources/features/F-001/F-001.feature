...
Feature: F-001 : Create and update an organisation and invite a user
  ...
  Scenario: Create, update an organisation and invite a user
    Given a successful call [to IDAM to invite super user] as in [S-001_Invite_Super_User_In_IDAM],
    ...
    Then a successful call [to IDAM to invite a user] as in [S-001_Invite_A_User_In_IDAM],
