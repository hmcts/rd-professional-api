...
public abstract class AuthorizationFunctionalTest {
    ...
    protected RequestSpecification bearerTokenForPuiManager;
    ...
    public RequestSpecification generateBearerTokenForPuiManager(String role) {
        Map<String, Object> response = professionalApiClient.createOrganisation();
        ...
        bearerTokenForPuiManager = professionalApiClient.getMultipleAuthHeadersExternal(role, firstName, lastName, userEmail);
