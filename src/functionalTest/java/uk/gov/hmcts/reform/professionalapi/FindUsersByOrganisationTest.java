...
public class FindUsersByOrganisationTest extends AuthorizationFunctionalTest {
    ...
    public void find_all_users_for_an_organisation_with_pagination_should_return_200() {
        ...
        Map<String, Object> searchResponse = professionalApiClient.searchUsersByOrganisationWithPagination(orgIdentifierResponse, hmctsAdmin, "False", HttpStatus.OK, 0, 1, paginationToggle);

        validateRetrievedUsers(searchResponse, "any");
        List<HashMap> professionalUsersResponses = (List<HashMap>) searchResponse.get("users");

        Map<String, Object> searchResponse2 = professionalApiClient.searchUsersByOrganisationWithPagination(orgIdentifierResponse, hmctsAdmin, "False", HttpStatus.OK, 1, 1, paginationToggle);
        ...
        if ("true".equalsIgnoreCase(paginationToggle)) {
            ...
            assertThat(professionalUsersResponses.size()).isEqualTo(2);
        }
    ...
    public void find_all_users_for_an_organisation_external_with_pagination_should_return_200() {
        ...
        Map<String, Object> searchResponse = professionalApiClient.searchAllActiveUsersByOrganisationExternalWithPagination(HttpStatus.OK, specification, "Active", 0, 1, paginationToggle);
        ...
        Map<String, Object> searchResponse2 = professionalApiClient.searchAllActiveUsersByOrganisationExternalWithPagination(HttpStatus.OK, specification, "Active", 1, 1, paginationToggle);
