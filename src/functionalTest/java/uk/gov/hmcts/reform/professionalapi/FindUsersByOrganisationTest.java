...
public class FindUsersByOrganisationTest extends AuthorizationFunctionalTest {
    ...
    public RequestSpecification generateBearerTokenForPuiManager() {
        ...
        bearerTokenForPuiUserManager = professionalApiClient.getMultipleAuthHeadersExternal(puiUserManager, firstName,
                lastName, userEmail);
    ...
    @Test
    public void ac1_find_all_active_users_with_roles_for_an_org_with_non_pui_user_manager_role_should_return_200() {
    ...
    @Test
    public void ac2_shld_rtn_200_active_usrs_with_roles_for_an_org_with_non_pui_user_mgr_role_when_no_sts_provided() {
        Map<String, Object> response = professionalApiClient.searchOrganisationUsersByStatusExternal(HttpStatus.OK,
    ...
    public void ac3_find_all_status_users_for_an_organisation_with_pui_user_manager_should_return_200() {
        Map<String, Object> response = professionalApiClient.searchOrganisationUsersByStatusExternal(HttpStatus.OK,
                generateBearerTokenForPuiManager(), "");
    ...
    public void ac4_find_all_active_users_for_an_organisation_with_pui_user_manager_should_return_200() {
        Map<String, Object> response = professionalApiClient.searchOrganisationUsersByStatusExternal(HttpStatus.OK,
                generateBearerTokenForPuiManager(), "Active");
        validateRetrievedUsers(response, "ACTIVE");
    }

    @Test
    public void ac5_find_all_suspended_usrs_for_an_org_pui_user_manager_when_no_suspended_usr_exists_should_rtn_404() {
        professionalApiClient.searchOrganisationUsersByStatusExternal(HttpStatus.NOT_FOUND,
                generateBearerTokenForPuiManager(), "Suspended");
    }
    
    @Test
    public void ac6_find_all_sts_usr_for_an_organisation_with_pui_user_mgr_with_invalid_sts_provided_should_rtn_400() {
        professionalApiClient.searchOrganisationUsersByStatusExternal(HttpStatus.BAD_REQUEST,
                generateBearerTokenForPuiManager(), "INVALID");
    }
