...
public class RetrieveOrganisationByOrgIdTest extends AuthorizationFunctionalTest {
    ...
    @Test
    public void rdcc117_ac3_user_without_appropriate_permission_cannot_retrieve_org_by_orgIdentifier_for_external() {
        Map<String, Object> response = professionalApiClient
                .retrievePbaAccountsForAnOrganisationExternal(HttpStatus.FORBIDDEN,
                        generateBearerTokenForUser("caseworker-caa"));
