...
public class RetrieveOrganisationByOrgIdTest extends AuthorizationFunctionalTest {
    ...
    public void can_retrieve_organisation_by_orgIdentifier_for_pui_user_manager_External() {
        Map<String, Object> response = professionalApiClient.retrievePbaAccountsForAnOrganisationExternal(HttpStatus.OK, generateBearerTokenForUser(puiUserManager));
    ...
    public void can_retrieve_organisation_by_orgIdentifier_for_pui_caa_External() {
        Map<String, Object> response = professionalApiClient.retrievePbaAccountsForAnOrganisationExternal(HttpStatus.OK, generateBearerTokenForUser(puiCaa));
        assertThat(response).isNotEmpty();
        responseValidate(response);
    }
