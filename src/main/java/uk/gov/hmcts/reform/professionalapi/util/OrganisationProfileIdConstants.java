...
public class OrganisationProfileIdConstants {
    ...
    public static final String OGD_HMRC_PROFILE = "OGD_HMRC_PROFILE";
    public static final String OGD_CICA_PROFILE = "OGD_CICA_PROFILE";
    public static final String OGD_CAFCASS_PROFILE_CYMRU = "OGD_CAFCASS_PROFILE_CYMRU";
