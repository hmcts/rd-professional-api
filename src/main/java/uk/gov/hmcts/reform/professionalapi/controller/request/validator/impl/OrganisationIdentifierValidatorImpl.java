...
public class OrganisationIdentifierValidatorImpl implements OrganisationIdentifierValidator {
    ...
    public List<UpdateOrgResponse> validateOrganisationId(String orgId, List<UpdateOrgResponse>
        updateOrgResponsesList, Organisation existingOrganisation) {

        if (!orgId.matches("^[A-Z0-9]{7}$")) {
            updateOrgResponsesList.add(new UpdateOrgResponse(orgId, "failure",
