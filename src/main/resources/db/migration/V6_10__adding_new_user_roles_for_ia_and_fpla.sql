ALTER TABLE PRD_ENUM ADD COLUMN ENABLED VARCHAR(8) DEFAULT 'YES' NOT NULL;
...
UPDATE PRD_ENUM SET ENABLED = 'NO' WHERE ENUM_CODE = 31;
UPDATE PRD_ENUM SET ENABLED = 'NO' WHERE ENUM_CODE = 32;
UPDATE PRD_ENUM SET ENABLED = 'NO' WHERE ENUM_CODE = 33;
UPDATE PRD_ENUM SET ENABLED = 'NO' WHERE ENUM_CODE = 34;
UPDATE PRD_ENUM SET ENABLED = 'NO' WHERE ENUM_CODE = 35;
