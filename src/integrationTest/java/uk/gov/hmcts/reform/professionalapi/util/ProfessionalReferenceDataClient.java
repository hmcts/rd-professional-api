...
public class ProfessionalReferenceDataClient {
    ...
    public Map<String, Object> findLegacyPbaAccountsByUserEmail(String email) {
        return getRequest("/search/pba/{email}",PUI_CASE_MANAGER, email);
    }
