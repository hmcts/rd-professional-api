...
class FindMFAByUserIDTest extends AuthorizationEnabledIntegrationTest {
    ...
    private Map<String, Object> createOrganization() {
        ...
        String userIdentifier = persistedSuperUser.getUserIdentifier() == null
                ? null
                : persistedSuperUser.getUserIdentifier().toString();
        return professionalReferenceDataClient.findMFAByUserID(userIdentifier);
    }
